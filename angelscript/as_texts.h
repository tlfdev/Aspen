...
#define TXT_BASE_DOESNT_HAVE_CPY_CONSTR_OR_DEF_CONSTR                                                                  \
    "Base class doesn't have copy constructor or default constructor and assign operator. Make explicit call to base " \
    "constructor"
...
// TODO: Should be something like "This platform requires that AngelScript knows the exact content of the type '%s' in
// order to pass by value to application in native calling convention"
...
// TODO: Should be something like "This platform requires that AngelScript knows the exact content of the type '%s' in
// order to return by value from application in native calling convention"

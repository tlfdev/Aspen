...
// MSVC2015 can now use CLang too, but it shouldn't go in here
    ...
    // Enable use of computed gotos by default
        ...
        // Also in clang 5.0 but how do i test for that? Should use __has_extension, but I don't know the name of the
    ...
    // Marmalade is a cross platform SDK. It uses g++ to compile for iOS and Android
        ...
        // Identify for which CPU the library is being built
            ...
            #define COMPLEX_RETURN_MASK \
                (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
    ...
    // Linux
        ...
        #define COMPLEX_RETURN_MASK (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
            ...
            // The assembler code currently doesn't support arm v4
                ...
                // TODO: The stack unwind on exceptions currently fails due to the assembler code in

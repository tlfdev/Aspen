...
class CScriptBuilder
{
  public:
    ...
    //         <0 on error
    int AddSectionFromMemory(const char* sectionName, const char* scriptCode, unsigned int scriptLength = 0,
                             int lineOffset = 0);
  ...
  protected:
    ...
    {
        SMetadataDecl(std::vector<std::string> m, std::string n, std::string d, int t, std::string c, std::string ns)
